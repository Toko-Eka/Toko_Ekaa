<html>
<head>
  <title>Cetak Laporan Rinci Penjualan</title>
  <style>
    .table {
...
<body>
    <h4 style="margin-bottom: 5px;">Laporan Rinci Penjualan</h4>
  <?php echo $label ?>
...
<!-- 
    ...
    error_reporting(0);
        if(empty($transak)){ // Jika data tidak ada
          ...
          $subtotal = 0;
            ...
            foreach($transak as $data){ // Looping hasil data transaksi       
                 ...
                 if($supp !== $data->KDSUP){
                     ...
                     if($no > 1){
                         echo "<tr>";
                         echo "<td class='num' align='right' colspan=5><b>Subtotal</td>";
          ...
          echo "</tr>";
          echo "<tr>";
            echo "<td class='num' align='right' colspan=5><b>Grand Total</td>";
            echo "<td class='num' align='right'><b>".number_format($totalQty, 0, ',', '.')."</td>";
            echo "<td class='num' align='right'><b>".number_format($total, 0, ',', '.')."</td>";
            echo "</tr>";
