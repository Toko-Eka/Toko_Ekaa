...
<body>
    <h4 style="margin-bottom: 5px;">Laporan Transaksi Penjualan</h4>
  <?php echo $label ?>
  ...
  error_reporting(0);
            ...
            $row[] = $unpaid;
                ...
                echo "<td style='text-align:right;width: 100px;'>".$data->qty."</td>";
                echo "<td style='text-align:right;width: 100px;'>".$data->subtotal."</td>";
                // echo "</tr>";
                //       echo "<tr>";
                //       echo " <th></th>";
                //       echo " <th>Nama Brg</th>";
            ...
            echo "<td style='text-align:right;width: 100px;'></td>";
            echo "<td style='text-align:right;width: 100px;'></td>";
            echo "<td style='text-align:right;width: 100px;'>".$totalQty."</td>";
