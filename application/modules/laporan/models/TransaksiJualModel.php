...
class TransaksiJualModel extends CI_Model
{
    ...
    var $orderDet = array('det.KDSUP' => 'asc'); // default order 
    ...
    public function fetchSum($tgl_awal, $tgl_akhir, $brg, $supp)
    {

        error_reporting(0);
        $query = $this->db->query("SELECT SUM(det.TOTAL) as TOTAL,SUM(det.JMLBRG) AS JML FROM xTransakDetil as det INNER JOIN xTransak as tr ON tr.NOTA = det.NOTA WHERE det.FLAG IS NULL AND tr.KODETRN='J'AND det.KDSUP ='$supp' AND det.NAMABRG LIKE '%$brg%'  AND tr.tgl BETWEEN '$tgl_awal' AND '$tgl_akhir' GROUP BY det.NOTA;");
    ...
    public function fetchSumSearch($tgl_awal, $tgl_akhir, $supp, $brg)
    {

        error_reporting(0);
        $query = $this->db->query("SELECT SUM(det.TOTAL) as TOTAL,SUM(det.JMLBRG) AS JML FROM xTransakDetil as det INNER JOIN xTransak as tr ON tr.NOTA = det.NOTA WHERE det.FLAG IS NULL AND tr.KODETRN='J' AND det.NAMABRG ='$brg' AND det.KDSUP ='$supp'AND tr.tgl BETWEEN '$tgl_awal' AND '$tgl_akhir' AND ( det.NOTA LIKE '%A%' ESCAPE '!' OR det.TGL LIKE '%A%' ESCAPE '!' OR det.NAMABRGA LIKE '%A%' ESCAPE '!' OR det.KDSUP LIKE '%A%' ESCAPE '!' ) GROUP BY det.NOTA;");
    ...
    public function fetchSumWOBrg($tgl_awal, $tgl_akhir, $supp)
    {
        ...
        $query = $this->db->query("SELECT SUM(det.TOTAL) as TOTAL,SUM(det.JMLBRG) AS JML FROM xTransakDetil as det INNER JOIN xTransak as tr ON tr.NOTA = det.NOTA WHERE det.FLAG IS NULL AND tr.KODETRN='J' AND det.KDSUP ='$supp' AND tr.tgl BETWEEN '$tgl_awal' AND '$tgl_akhir' GROUP BY det.NOTA;");
    ...
    public function fetchSumWoSupp($tgl_awal, $tgl_akhir, $brg)
    {
        ...
        $query = $this->db->query("SELECT SUM(det.TOTAL) as TOTAL,SUM(det.JMLBRG) AS JML FROM xTransakDetil as det INNER JOIN xTransak as tr ON tr.NOTA = det.NOTA WHERE det.FLAG IS NULL AND tr.KODETRN='J' AND det.NAMABRG LIKE '%$brg%' ESCAPE '!' AND tr.tgl BETWEEN '$tgl_awal' AND '$tgl_akhir' GROUP BY det.NOTA;");
    ...
    {
        $query = "
        SELECT det.*, tr.KODETRN  FROM xTransakDetil AS det INNER JOIN xTransak as tr ON tr.NOTA = det.NOTA WHERE tr.tgl BETWEEN '$tgl_awal' AND '$tgl_akhir' AND  tr.KODETRN= 'J' AND det.FLAG IS NULL AND det.NAMABRG LIKE'%$brg%' ORDER BY det.KDSUP;
    ";
        // var_dump($query);DIE;
        return $this->db->query($query)->result();
    }
    ...
    {
        $query = "
        SELECT det.*, tr.KODETRN FROM xTransakDetil AS det INNER JOIN xTransak as tr ON tr.NOTA = det.NOTA WHERE tr.tgl BETWEEN '$tgl_awal' AND '$tgl_akhir' AND  tr.KODETRN= 'J' AND det.FLAG IS NULL AND det.KDSUP='$supp' ORDER BY det.KDSUP;
    ";
        // var_dump($query);DIE;
        return $this->db->query($query)->result();
    }
    ...
    {
        $query = "
    SELECT det.*, tr.KODETRN FROM xTransakDetil AS det INNER JOIN xTransak as tr ON tr.NOTA = det.NOTA WHERE tr.tgl BETWEEN '$tgl_awal' AND '$tgl_akhir' AND  tr.KODETRN= 'J' AND det.FLAG IS NULL ORDER BY det.KDSUP;
    ";
        // var_dump($query);die;
        return $this->db->query($query)->result();
    }
    public function view_by_dateDet($tgl_awal, $tgl_akhir, $supp, $brg)
    {
        ...
        $query = "
        SELECT det.*, tr.KODETRN FROM xTransakDetil AS det INNER JOIN xTransak as tr ON tr.NOTA = det.NOTA WHERE tr.tgl BETWEEN '$tgl_awal' AND '$tgl_akhir' AND  tr.KODETRN= 'J' AND det.FLAG IS NULL AND det.KDSUP='$supp' AND det.NAMABRG LIKE'%$brg%' ORDER BY det.KDSUP;
      ";
