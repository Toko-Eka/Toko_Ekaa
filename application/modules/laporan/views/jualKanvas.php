  ...
  <div class="card" style="margin: auto; width: 100%;">
    ...
    <div class="card-body">
      <div class="form-group">
        <h4>Laporan Transaksi Jenis Kanvas</h4>
        <hr>
        <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <div class="table-responsive-md">
                <table id='tbkanvas' class='table table-striped' style="width:100%">
...
$(document).ready(function() {
    ...
    table = $('#tbkanvas').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('laporan/JualJenis/kanvasList' )?>/" + master +"/" + detil,
                "type": "POST",
                "data": function(data) {
  ...
  function print() {
    ...
    var notaaa = $('#draw').val();
    if (notaaa.length < 1){
    myw = window.open('<?php echo base_url() ?>laporan/JualJenis/kanvasPrintWONota/' + awal + '/' + akhir+ '/' + master + '/' + detil );
;
    ...
    myw.focus();
      ...
      myw = window.open('<?php echo base_url() ?>laporan/JualJenis/kanvasPrint/' + awal + '/' + akhir + '/' + notaaa+ '/' + master + '/' + detil );
;
...
myw.focus();
  ...
  function excel() {
    ...
    var notaaa = $('#draw').val();
    if (notaaa.length < 1){
    myw = window.open('<?php echo base_url() ?>laporan/JualJenis/kanvasExcelWONota/' + awal + '/' + akhir+ '/' + master + '/' + detil );
;
    ...
    myw.focus();
      ...
      myw = window.open('<?php echo base_url() ?>laporan/JualJenis/kanvasExcel/' + awal + '/' + akhir + '/' + notaaa+ '/' + master + '/' + detil );
;
...
$.ajax({
    type: "POST",
    url: "<?php echo base_url('laporan/JualJenis/getGrandTotalKanvas') ?>",
    dataType: "JSON",
    data: {
        "tgl_awal": tglAwal,
        "tgl_akhir": tglAkhir,
