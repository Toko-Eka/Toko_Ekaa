...
$supp='';
            foreach($res as $data){ // Looping hasil data transaksi
              if($supp !== $data->KDSUP){
                ...
                if($count > 1){
                    ...
                    echo "<td class='num' align='right'><b>".$totalA."</td>";
                    echo "</tr>";
     ...
     <?php
             ...
             $totalqty += $data->AKHIR;
                ...
                echo "<td style='text-align:right;width: 100px;'>".$data->AKHIR."</td>";
                echo "<td style='text-align:right;width: 100px;'>".$data->HBT."</td>";
                echo "<td style='text-align:right;width: 100px;'>".$data->TOTAL."</td>";
