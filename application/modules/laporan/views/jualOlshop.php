...
<section>
                  ...
                  <h4>Laporan Transaksi Jenis Olshop</h4>
                  <hr>
        ...
        <div class="col-md-6">
          <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <div class="table-responsive-md">
                <table id='tbOlshop' class='table table-striped' style="width:100%">
...
var startDate = moment();
    ...
    table = $('#tbOlshop').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('laporan/JualJenis/olshopList')?>/" + master +"/" + detil,
                "type": "POST",
                "data": function(data) {
    ...
    var notaaa = $('#draw').val();
    if (notaaa.length < 1){
    myw = window.open('<?php echo base_url() ?>laporan/JualJenis/olshopPrintWONota/' + awal + '/' + akhir+ '/' + master + '/' + detil );
    ...
    myw.focus();
      ...
      myw = window.open('<?php echo base_url() ?>laporan/JualJenis/olshopPrint/' + awal + '/' + akhir + '/' + notaaa+ '/' + master + '/' + detil );
...
myw.focus();
  ...
  function excel() {
    ...
    var notaaa = $('#draw').val();
    if (notaaa.length < 1){
    myw = window.open('<?php echo base_url() ?>laporan/JualJenis/olshopExcelWONota/' + awal + '/' + akhir+ '/' + master + '/' + detil );
    ...
    myw.focus();
      ...
      myw = window.open('<?php echo base_url() ?>laporan/JualJenis/olshopExcel/' + awal + '/' + akhir + '/' + notaaa+ '/' + master + '/' + detil );
...
$.ajax({
    type: "POST",
    url: "<?php echo base_url('laporan/JualJenis/getGrandTotalOlshop') ?>",
    dataType: "JSON",
    data: {
        "tgl_awal": tglAwal,
        "tgl_akhir": tglAkhir,
