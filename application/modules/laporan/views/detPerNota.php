    ...
    <div class="card" style="margin: auto; width: 100%;">
        ...
        <div class="card-body">
            <div class="form-group">
                <h4>Laporan Rincian Transaksi Jual Per Nota</h4>
                <hr>
                <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="btn-group" role="group" aria-label="Basic example">
            ...
            <div class="table-responsive-md">
                <table id='detPerNota' class='table table-striped' style="width:100%">
...
<style>
    ...
    function draw_grid() {
        ...
        table = $('#detPerNota').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('laporan/RinciJualNota/detPerNotaList')?>/" + master +"/" + detil,
                "type": "POST",
                "data": function(data) {
    ...
    function print() {
        ...
        var value = $('#draw').val();
            if (value.length > 0) {
                myw = window.open('<?php echo base_url() ?>laporan/RinciJualNota/detPerNotaPrintSearch/' + awal + '/' + akhir +'/'+btoa(value)+ '/' + master + '/' + detil );
...
myw.focus();
                ...
                myw = window.open('<?php echo base_url() ?>laporan/RinciJualNota/detPerNotaPrint/' + awal + '/' + akhir+ '/' + master + '/' + detil );
    ...
    function excel() {
        ...
        var value = $('#draw').val();
            if (value.length > 0) {
                myw = window.open('<?php echo base_url() ?>laporan/RinciJualNota/detPerNotaexcelSearch/' + awal + '/' + akhir +'/'+btoa(value)+ '/' + master + '/' + detil );
...
myw.focus();
                ...
                myw = window.open('<?php echo base_url() ?>laporan/RinciJualNota/detPerNotaexcel/' + awal + '/' + akhir+ '/' + master + '/' + detil );
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url('laporan/RinciJualNota/getGrandTotalWBrg') ?>",
      dataType: "JSON",
      data: {
        "tgl_awal": tglAwal,
        "tgl_akhir": tglAkhir,
  ...
  function getGrandTotal() {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url('laporan/RinciJualNota/getGrandTotal') ?>",
      dataType: "JSON",
      data: {
        "tgl_awal": tglAwal,
        "tgl_akhir": tglAkhir,
