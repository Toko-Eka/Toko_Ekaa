  ...
  <div class="card" style="margin: auto; width: 100%;">
    ...
    <div class="card-body">
      <div class="form-group">
        <h4>Laporan Transaksi Jenis Program</h4>
        <hr>
        <div class="form-group">
      ...
      <div class="table-responsive-md">
        <table id='tbProgram' class='table table-striped' style="width:100%">
...
$(document).ready(function() {
  ...
  function draw_grid() {
    table = $('#tbProgram').DataTable({
      ...
      "ajax": {
        "url": "<?php echo site_url('laporan/JualJenis/programList')?>/" + master +"/" + detil,
        "type": "POST",
        "data": function(data) {
  ...
  function print() {
    ...
    var notaaa = $('#draw').val();
    if (notaaa.length < 1){
    myw = window.open('<?php echo base_url() ?>laporan/JualJenis/programPrintWONota/' + awal + '/' + akhir+ '/' + master + '/' + detil );
    ...
    myw.focus();
      ...
      myw = window.open('<?php echo base_url() ?>laporan/JualJenis/programPrint/' + awal + '/' + akhir + '/' + notaaa+ '/' + master + '/' + detil );
...
myw.focus();
  ...
  function excel() {
    ...
    var notaaa = $('#draw').val();
    if (notaaa.length < 1){
    myw = window.open('<?php echo base_url() ?>laporan/JualJenis/programExcelWONota/' + awal + '/' + akhir+ '/' + master + '/' + detil );
    ...
    myw.focus();
      ...
      myw = window.open('<?php echo base_url() ?>laporan/JualJenis/programExcel/' + awal + '/' + akhir + '/' + notaaa+ '/' + master + '/' + detil );
...
$.ajax({
    type: "POST",
    url: "<?php echo base_url('laporan/JualJenis/getGrandTotalProgram') ?>",
    dataType: "JSON",
    data: {
        "tgl_awal": tglAwal,
        "tgl_akhir": tglAkhir,
...
$.ajax({
    type: "POST",
    url: "<?php echo base_url('laporan/JualJenis/getGrandTotalWBoth') ?>",
    dataType: "JSON",
    data: {
        "tgl_awal": tglAwal,
        "tgl_akhir": tglAkhir,
...
$.ajax({
    type: "POST",
    url: "<?php echo base_url('laporan/JualJenis/getGrandTotalWSupp') ?>",
    dataType: "JSON",
    data: {
        "tgl_awal": tglAwal,
        "tgl_akhir": tglAkhir,
...
$.ajax({
    type: "POST",
    url: "<?php echo base_url('laporan/JualJenis/getGrandTotalWBrg') ?>",
    dataType: "JSON",
    data: {
        "tgl_awal": tglAwal,
        "tgl_akhir": tglAkhir,
