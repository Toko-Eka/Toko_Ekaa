...
$sup= array();
        ...
        <?php
            ...
            echo "<td style='width: 100px;'>".$data->KDSUP."</td>";
                echo "<td style='text-align:right;width: 100px;'>".$data->HET."</td>";
                echo "<td style='text-align:right;width: 100px;'>".round((float)$data->RLABA * 1 ) . '%';"</td>";
                echo "<td style='text-align:right;width: 100px;'>".$data->HBT."</td>";
                echo "<td style='text-align:right;width: 100px;'>".$data->JHAR1."</td>";
                echo "<td style='text-align:right;width: 100px;'>".$data->JHAR2."</td>";
                echo "<td style='text-align:right;width: 100px;'>".$data->JHAR3."</td>";
                echo "<td style='text-align:right;width: 100px;'>". $data->JHAR4."</td>";
                echo "<td style='text-align:right;width: 100px;'>".$data->JHAR5."</td>";
                echo "<td style='text-align:right;width: 100px;'>".$data->HKANVAS."</td>";
