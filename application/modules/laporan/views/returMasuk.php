<section>
  ...
  <div class="card" style="margin: auto; width: 100%;">
    <div class="card-header">Laporan Retur Masuk</div>
    <div class="card-body">
...
<script>
  ...
  function draw_grid() {
        ...
        table = $('#retM').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('Laporan/L_returMasuk/retMasukList') ?>",
                "type": "POST",
                "data": function(data) {
  ...
  function print() {
    if ($('#AllSupp').is(':checked')) {
      ...
      myw = window.open('<?php echo base_url() ?>Laporan/L_returMasuk/print/' + awal + '/' + akhir);
      ...
      if (supp.length < 1) {
        error();
                    ...
                    $('#validasifilt').hide();
      myw = window.open('<?php echo base_url() ?>Laporan/L_returMasuk/printWSupp/' + awal + '/' + akhir + '/' + supp);
  ...
  function excel() {
    if ($('#AllSupp').is(':checked')) {
      var awal = $('#split1').val();
      var akhir = $('#split2').val();
      myw = window.open('<?php echo base_url() ?>Laporan/L_returMasuk/excel/' + awal + '/' + akhir);
      ...
      if (supp.length < 1) {
        error();
                    ...
                    $('#validasifilt').hide();
      myw = window.open('<?php echo base_url() ?>Laporan/L_returMasuk/excelWSupp/' + awal + '/' + akhir + '/' + supp);
      myw.document.close(); //missing code
