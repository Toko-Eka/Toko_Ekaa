                      ...
                      <div class="input-group-text">
                        <i class="fas fa-calendar"></i>
                                    ...
                                    <div class="col-md-5">
                                       ...
                                       <select class="form-control" name="" id="paidStat">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            table = $('#tableHisjual').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo site_url('Pembelian/TransBeli/trBeliList') ?>",
                    "type": "POST",
                    "data": function(data) {
...
$.ajax({
    type: "POST",
    url: "<?php echo base_url('Pembelian/TransBeli/getGrandTotalMaster') ?>",
    dataType: "JSON",
    data: {
        "tgl_awal": tglAwal,
        "tgl_akhir": tglAkhir,
