<html>
<head>
  <title>Cetak Laporan Rinci Pembelian</title>
  <style>
    .table {
...
<body>
    <h4 style="margin-bottom: 5px;">Laporan Rinci Pembelian</h4>
  <?php echo $label ?>
  ...
  <tr>
    <th style="width: 5%;">No</th>
      ...
      <th style="width: 32%;">Kode Barang</th>
    ...
    // error_reporting(0);
        if(empty($transak)){ // Jika data tidak ada
          ...
          $subtotal = 0;
            ...
            foreach($transak as $data){ // Looping hasil data transaksi       
                 ...
                 if($supp !== $data->KDSUP){
                     ...
                     if($no > 1){
                         echo "<tr>";
                         echo "<td class='num' align='right' colspan=4><b>Subtotal</td>";
          ...
          <?php
                ...
                echo "<td style='width: 500px;'>".$data->NOTA."</td>";
                echo "<td style='width: 500px;'>".$data->KDBRG."</td>";
          ...
          echo "<tr>";
          echo "<td class='footer text' align='right' colspan=6><b></td>";
          echo "</tr>";
          echo "<tr>";
            echo "<td class='num' align='right' colspan=4><b>Grand Total</td>";
            echo "<td class='num' align='right'><b>".$totalQty."</td>";
            echo "<td class='num' align='right'><b>".$total."</td>";
            echo "</tr>";
