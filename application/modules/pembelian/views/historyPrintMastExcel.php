...
<body>
  ...
  error_reporting(0);
            ...
            $row[] = $unpaid;
                ...
                echo "<td style='text-align:right;width: 100px;'>".round($data->subtotal)."</td>";
                // echo "</tr>";
                //       echo "<tr>";
                //       echo " <th></th>";
                //       echo " <th>Nama Brg</th>";
            ...
            echo "<td style='text-align:right;width: 100px;'></td>";
            echo "<td style='text-align:right;width: 100px;'></td>";
            echo "<td style='text-align:right;width: 100px;'>".round($totalQty)."</td>";
          
            echo "<td style='text-align:right;width: 100px;'>".round($total)."</td>";
