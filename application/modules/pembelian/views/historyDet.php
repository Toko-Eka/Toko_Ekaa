...
$.ajax({
    type: "POST",
    url: "<?php echo base_url('Pembelian/transBeli/getGrandTotal') ?>",
    dataType: "JSON",
    data: {
        "tgl_awal": tglAwal,
        "tgl_akhir": tglAkhir,
...
$.ajax({
    type: "POST",
    url: "<?php echo base_url('Pembelian/transBeli/getGrandTotalWBoth') ?>",
    dataType: "JSON",
    data: {
        "tgl_awal": tglAwal,
        "tgl_akhir": tglAkhir,
...
$.ajax({
    type: "POST",
    url: "<?php echo base_url('Pembelian/transBeli/getGrandTotalWSupp') ?>",
    dataType: "JSON",
    data: {
        "tgl_awal": tglAwal,
        "tgl_akhir": tglAkhir,
...
$.ajax({
    type: "POST",
    url: "<?php echo base_url('Pembelian/transBeli/getGrandTotalWBrg') ?>",
    dataType: "JSON",
    data: {
        "tgl_awal": tglAwal,
        "tgl_akhir": tglAkhir,
...
return false;
 ...
 function draw_grid(){
    ...
    table = $('#tableHisjual').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('Pembelian/transBeli/trBeliDetList')?>/" + master +"/" + detil,
            "type": "POST",
            "data": function ( data ) {
...
function excel() {
        ...
        if (value.length < 1 && !$('#AllSupp').is(':checked')) {
            ...
            var supp = $('#supp').val();
                 if (supp.length < 1) {
                    ...
                    $('#validasifilt').hide();
            // var brg= $('#brg').val();
            myw = window.open('<?php echo base_url() ?>Pembelian/transBeli/excelDetWOBrg/' + tglAwal + '/' + tglAkhir + '/' + supp+ '/' + master + '/' + detil );
            ...
            // var supp= $('#supp').val();
            var brg = $('#draw').val();
            myw = window.open('<?php echo base_url() ?>Pembelian/transBeli/excelDetWOSupp/' + tglAwal + '/' + tglAkhir + '/' + btoa(brg)+ '/' + master + '/' + detil );
            ...
            if (supp.length < 1) {
                error();
                    ...
                    $('#validasifilt').hide();
            myw = window.open('<?php echo base_url() ?>Pembelian/transBeli/excelDet/' + tglAwal + '/' + tglAkhir + '/' + supp + '/' + btoa(brg)+ '/' + master + '/' + detil );
            ...
            // var supp= $('#supp').val();
            var brg = $('#draw').val();
            myw = window.open('<?php echo base_url() ?>Pembelian/transBeli/excelDetNo/' + tglAwal + '/' + tglAkhir+ '/' + master + '/' + detil );
    ...
    function print() {
        ...
        if (value.length < 1 && !$('#AllSupp').is(':checked')) {
            ...
            var supp = $('#supp').val();
            // var brg= $('#brg').val();
            myw = window.open('<?php echo base_url() ?>Pembelian/transBeli/printDetWOBrg/' + tglAwal + '/' + tglAkhir + '/' + supp+ '/' + master + '/' + detil );
            ...
            // var supp= $('#supp').val();
            var brg = $('#draw').val();
            myw = window.open('<?php echo base_url() ?>Pembelian/transBeli/printDetWOSupp/' + tglAwal + '/' + tglAkhir + '/' + btoa(brg)+ '/' + master + '/' + detil );
            ...
            var supp = $('#supp').val();
            var brg = $('#draw').val();
            myw = window.open('<?php echo base_url() ?>Pembelian/transBeli/printDet/' + tglAwal + '/' + tglAkhir + '/' + supp + '/' + btoa(brg)+ '/' + master + '/' + detil );
            ...
            // var supptr= $('#supp').val();
            var brg = $('#draw').val();
            myw = window.open('<?php echo base_url() ?>Pembelian/transBeli/printDetNo/' + tglAwal + '/' + tglAkhir+ '/' + master + '/' + detil );
