...
class Page {
	...
	private $_header		= 'temp/v_header';		// page header
	private $_left_content	= 'temp/v_footer';	// page left content
	private $_content		= '';							// page content
	private $_template		= 'main';					// default template	
	 ...
	 * Display the page
	 */
	function view($content = 'temp/main_content', $data = array()){
		$this->_header;
		$this->_left_content;
		$this->_content($content);
		$this->_data($data);
		...
		$this->_set_data();
		$this->_CI->load->view('temp/'.$this->_template, $this->_data);
	}
